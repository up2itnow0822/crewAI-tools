...
Third-party tools built by the community for CrewAI agents:

| Tool | PyPI | Description |
|------|------|-------------|
| [crewai-tool-agentwallet](https://github.com/agentwallet-sdk/crewai-tool-agentwallet) | [PyPI](https://pypi.org/project/crewai-tool-agentwallet/) | Non-custodial wallet for agents — EVM transfers, x402 payments, 17-chain CCTP bridge, on-chain spend limits |
